...
def test_stdlib_imports_are_not_modified(chk_script_output) -> None:
    chk_script_output(
        script_path="single_file_using_stdlib/hello", expected_output=b"f7ff9e8b7bb2e09b70935a5d785e0cc5d9d0abf0\n"
    )


def test_stdlib_module_in_package_is_not_generated(chk_script_output) -> None:
    chk_script_output(
...
def test_script_that_imports_local_module_is_converted_to_single_file(chk_script_output) -> None:
    chk_script_output(script_path="script_with_single_local_import/hello", expected_output=b"Hello\n")


def test_script_that_imports_local_package_is_converted_to_single_file(chk_script_output) -> None:
    chk_script_output(script_path="script_with_single_local_import_of_package/hello", expected_output=b"Hello\n")


def test_can_import_module_from_package(chk_script_output) -> None:
    chk_script_output(script_path="script_using_module_in_package/hello", expected_output=b"Hello\n")


def test_can_import_value_from_module_using_from_import_syntax(chk_script_output) -> None:
    chk_script_output(script_path="script_with_single_local_from_import/hello", expected_output=b"Hello\n")


def test_can_import_multiple_values_from_module_using_from_import_syntax(chk_script_output) -> None:
    chk_script_output(script_path="script_using_from_to_import_multiple_values/hello", expected_output=b"Hello\n")


def test_can_import_module_from_package_using_from_import_syntax(chk_script_output) -> None:
    chk_script_output(script_path="script_using_from_to_import_module/hello", expected_output=b"Hello\n")


def test_can_import_multiple_modules_from_module_using_from_import_syntax(chk_script_output) -> None:
    chk_script_output(script_path="script_using_from_to_import_multiple_modules/hello", expected_output=b"Hello\n")


def test_imported_modules_are_transformed(chk_script_output) -> None:
    chk_script_output(script_path="imports_in_imported_modules/hello", expected_output=b"Hello\n")


def test_circular_references_dont_cause_stack_overflow(chk_script_output) -> None:
    chk_script_output(script_path="circular_reference/hello", expected_output=b"Hello\n")


def test_explicit_relative_imports_with_single_dot_are_resolved_correctly(chk_script_output) -> None:
    chk_script_output(script_path="explicit_relative_import_single_dot/hello", expected_output=b"Hello\n")


def test_explicit_relative_imports_with_single_dot_in_package_init_are_resolved_correctly(chk_script_output) -> None:
    chk_script_output(script_path="explicit_relative_import_single_dot_in_init/hello", expected_output=b"Hello\n")


def test_explicit_relative_imports_from_parent_package_are_resolved_correctly(chk_script_output) -> None:
    chk_script_output(script_path="explicit_relative_import_from_parent_package/hello", expected_output=b"Hello\n")


def test_explicit_relative_imports_with_module_name_are_resolved_correctly(chk_script_output) -> None:
    chk_script_output(script_path="explicit_relative_import/hello", expected_output=b"Hello\n")


def test_explicit_relative_imports_with_module_name_in_package_init_are_resolved_correctly(chk_script_output) -> None:
    chk_script_output(script_path="explicit_relative_import_in_init/hello", expected_output=b"Hello\n")


def test_package_init_can_be_used_even_if_not_imported_explicitly(chk_script_output) -> None:
    chk_script_output(script_path="implicit_init_import/hello", expected_output=b"Hello\n")


def test_value_import_is_detected_when_import_is_renamed(chk_script_output) -> None:
    chk_script_output(script_path="import_from_as_value/hello", expected_output=b"Hello\n")


def test_module_import_is_detected_when_import_is_renamed(chk_script_output) -> None:
...
def test_can_explicitly_copy_shebang(chk_script_output) -> None:
    chk_script_output(
...
def test_modules_with_triple_quotes_can_be_bundled(chk_script_output) -> None:
    chk_script_output(script_path="module_with_triple_quotes/hello", expected_output=b"Hello\n'''\n\"\"\"\n")


def test_additional_python_modules_can_be_explicitly_included(chk_script_output) -> None:
    chk_script_output(
